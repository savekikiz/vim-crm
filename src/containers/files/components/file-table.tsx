  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-medium">Files ({uploadedFiles.length})</h3>
        <div className="flex gap-2">
          <Button onClick={onOpenFileDialog} size="sm" variant="outline">
            <CloudUpload />
            Add files
          </Button>
          <Button onClick={onClearFiles} size="sm" variant="outline">
            <Trash2 />
            Remove all
          </Button>
        </div>
